...
function Editdoctor() {
    ...
    useEffect(() => {
        fetch('http://localhost:3030/doctor/doctor-list/' + drId)
            .then(res => res.json())
    ...
    const handleSubmit = (e) => {
        ...
        fetch('http://localhost:3030/doctor/edit-doctor/'+drId, {
            method: "PATCH",
            body: formData
        })
            .then(res => res.json())
    ...
    return (
        <>
            ...
            <form className='container'>
                ...
                <div class="form-group col-4">
                    <label for="time" class="label">Joinig Date:</label>
                ...
                <button type="submit" class="button-submit" onClick={handleSubmit}>Edit Doctor</button>
            </form>
        </>
    );
}
