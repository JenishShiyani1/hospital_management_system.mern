...
function EditAppointment() {
    ...
    useEffect(() => {
        fetch('http://localhost:3030/appointment/list-appointment/' + editId , {method : "GET"})
        .then(res => res.json())
    ...
    const handleSubmit = (e) => {
        ...
        fetch('http://localhost:3030/appointment/edit-appointment/'+ editId, {
            method: "PATCH",
            body: formData
        })
            .then(res => res.json())
            .then(res => {
                if (res.success) {
                    ...
                    Swal.fire({
                        icon: "error",
                        title: "Oops...",
                        text: "Appointment is not updated!",
                    });
                }
            })
            .catch(error => {
            ...
            <div class="container">
                    <form>
                        ...
                        <div class="form-group">
                            <button type="submit" class="m-3 btn btn-primary" onClick={handleSubmit}>Update</button>
